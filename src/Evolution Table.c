...
const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
	...
	[SPECIES_MACHOKE] =          {{EVO_LEVEL, 38, SPECIES_MACHAMP, 0},
	...
	[SPECIES_HAUNTER] =          {{EVO_LEVEL, 40, SPECIES_GENGAR, 0},
	...
	[SPECIES_BOLDORE] =          {{EVO_ITEM, ITEM_LINK_CABLE, SPECIES_GIGALITH, 0},
								  {EVO_LEVEL, 40, SPECIES_GIGALITH, 0}},
	...
	[SPECIES_GURDURR] =          {{EVO_LEVEL, 40, SPECIES_CONKELDURR, 0},
	...
	[SPECIES_KARRABLAST] =       {{EVO_ITEM, ITEM_LINK_CABLE, SPECIES_ESCAVALIER, 0},
								  {EVO_LEVEL, 35, SPECIES_ESCAVALIER, 0}},
	...
	[SPECIES_SHELMET] =          {{EVO_ITEM, ITEM_LINK_CABLE, SPECIES_ACCELGOR, 0},
								  {EVO_LEVEL, 35, SPECIES_ACCELGOR, 0}},
	...
	[SPECIES_GRAVELER_A] =       {{EVO_ITEM, ITEM_LINK_CABLE, SPECIES_GOLEM_A, 0},
								  {EVO_LEVEL, 40, SPECIES_GOLEM_A, 0}},
